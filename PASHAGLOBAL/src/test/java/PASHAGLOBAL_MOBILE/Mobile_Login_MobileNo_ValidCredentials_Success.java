...
public class Mobile_Login_MobileNo_ValidCredentials_Success {
	WebDriver driver;
	
	@Given("^Mobile: Chrome browser, valid URL, Go button, valid mobile number, valid password and login button for suribet client$")
	public void mobile_chrome_browser_valid_URL_Go_button_valid_mobile_number_valid_password_and_login_button_for_suribet_client() throws Throwable {
	...
	public void mobile_open_the_chrome_browser_Enter_the_valid_URL_click_on_Go_button_click_on_login_button_enter_valid_mobile_number_password_and_click_on_Login_butotn_for_suribet_client() throws Throwable {
	...
	public void mobile_user_should_be_able_to_login_to_pasha_global_website_successfully_post_entering_valid_mobile_number_and_balance_should_be_displayed_for_suribet_client() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
