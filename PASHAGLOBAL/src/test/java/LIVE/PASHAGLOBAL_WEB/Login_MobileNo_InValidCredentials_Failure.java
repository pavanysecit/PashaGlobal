...
public class Login_MobileNo_InValidCredentials_Failure {
	WebDriver driver;
	
	@Given("^Chrome browser, valid URL, Go button, Invalid mobile number, valid password and login button for suribet client$")
	public void chrome_browser_valid_URL_Go_button_Invalid_mobile_number_valid_password_and_login_button_for_suribet_client() throws Throwable {
	...
	public void open_the_chrome_browser_Enter_the_valid_URL_click_on_Go_button_click_on_login_button_enter_invalid_mobile_number_password_and_click_on_Login_butotn_for_suribet_client() throws Throwable {
	...
	public void user_should_be_failed_to_login_to_the_website_post_entering_invalid_mobile_number_for_suribet_client() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
