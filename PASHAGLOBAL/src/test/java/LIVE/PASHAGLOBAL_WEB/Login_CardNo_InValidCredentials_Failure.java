...
public class Login_CardNo_InValidCredentials_Failure {
	WebDriver driver;
	...
	public void open_the_chrome_browser_Enter_the_valid_URL_click_on_Go_button_click_on_login_button_enter_invalid_card_number_card_pin_and_click_on_Login_butotn() throws Throwable {
	...
	public void user_should_be_failed_to_login_to_the_website_post_entering_invalid_card_details_for_suribet_client() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
