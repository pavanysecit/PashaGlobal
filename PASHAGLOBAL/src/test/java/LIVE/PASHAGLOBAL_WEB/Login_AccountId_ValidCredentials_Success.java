...
public class Login_AccountId_ValidCredentials_Success {
	WebDriver driver;
	
	@Given("^Chrome browser, valid URL, Go button, pasha global valid account id, valid password and login button$")
	public void chrome_browser_valid_URL_Go_button_pasha_global_valid_account_id_valid_password_and_login_button() throws Throwable {
	...
	public void open_the_chrome_browser_Enter_the_valid_URL_click_on_Go_button_click_on_login_button_enter_valid_account_id_password_and_click_on_Login_butotn() throws Throwable {
	...
	public void user_should_be_able_to_login_website_successfully_post_entering_valid_online_account_details_and_online_account_balance_should_be_displayed_for_suribet_client() throws Throwable {
	    Thread.sleep(2000);
	    driver.quit();
	}
}
